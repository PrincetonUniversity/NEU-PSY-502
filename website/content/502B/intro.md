...
| Tu 2/4 (*E*) | fMRI group-level analysis and correction for multiple tests | [`Slides`](https://docs.google.com/presentation/d/1rGPBRVYCUSHiTs8TSkZo9m7hDhuvHIm9Y4J0m0pwM2M/edit?usp=sharing) [`Code`](https://github.com/NEU502B/neu502b-2025/tree/master/fmri-3) | [`Nichols & Holmes, 2002`](https://doi.org/10.1002/hbm.1058) | [`Nichols & Holmes, 2002`](https://doi.org/10.1002/hbm.1058) [`Eklund et al., 2016`](https://doi.org/10.1073/pnas.1602413113)
| W 2/5 (*C*) | Dynamics in perception | [`Code`](Computation/Dynamics%20in%20Perception/intro.md)                                                                                                                             | [`Hopfield et al., 1982`](https://doi.org/10.1073/pnas.79.8.2554) |
...
| W 2/12 (*C*) | Decision making | [`Code`](Computation/Decision%20Making/intro.md)                                                                                                                                      | [`Bogacz et al., 2006`](https://doi.org/10.1037/0033-295X.113.4.700) |
...
| W 2/19 (*C*) | Reinforcement learning | [`Code`](Computation/Reinforcement%20Learning/intro.md)                                                                                                                               | [`Montague et al., 1996`](https://doi.org/10.1523/JNEUROSCI.16-05-01936.1996) [`Botvinick et al., 2020`](https://doi.org/10.1016/j.neuron.2020.06.014) |
...
| W 3/4 (*C*) | Statistical learning and backpropagation | [`Code`](https://princetonuniversity.github.io/NEU-PSY-502/content/502B/Computation/Statistical%20Learning%20and%20Backpropagation/intro.html) | [`Rumelhart et al., 1986`](https://doi.org/10.1038/323533a0) [`McClelland & Rogers, 2003`](https://doi.org/10.1038/nrn1076) |
...
| Tu 3/25 (*E*) | ~~EEG/MEG signal, preprocessing, and modeling~~<br>fMRI project data analysis | [`Code`](https://princetonuniversity.github.io/NEU-PSY-502/content/502B/Computation/Episodic%20Memory/intro.html) | [`Buzsáki et al., 2012`](https://doi.org/10.1038/nrn3241) [`Fries, 2015`](https://doi.org/10.1016/j.neuron.2015.09.034) |
